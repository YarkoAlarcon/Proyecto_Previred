...
public interface CC_Localizadores_Revisar_Bitacora {
	...
	String buscarArchivo ="//button[.//span[contains(text(), 'Adjuntar certificado')]]";
	...
	String optEmail = "//div[@id='isNoTieneEmail']//label[.//span[text()='Si']]"; //Seleciona opsion si/no email en este caso sera opcion no
	...
	String checknomovil ="//input[@id='isNoTieneTelefonoFijo']"; //
	...
	String optNivelEducacional = "//div[contains(@class, 'ant-select-item-option') and text()='Educación Superior']"; //De momento selecciona analfabeto
	...
	String Archivo = "//button[.//span[contains(text(), 'Adjuntar certificado')]]";
	...
	String subircertificadomedico = "//button[.//span[contains(text(), 'Adjuntar documento de cobertura')]]"; // Subir documento certificado Incapacidad
	...
	String clicksiprobar3 = "(//label[contains(@class, 'ant-radio-wrapper') and //span[text()='Si, Aprobar']])[5]"; // click en Si, Apobar 1er documento
	String clickAprobardoc = "(//label[contains(@class, 'ant-radio-wrapper') and //span[text()='Si, Aprobar']])[7]"; // click en Si, Apobar Final
