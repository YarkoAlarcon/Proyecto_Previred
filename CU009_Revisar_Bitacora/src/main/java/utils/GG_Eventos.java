...
public class GG_Eventos {
	...
	// subir a las opciones no visibles, mediante el teclado
		public static void subirScroll(WebDriver driver,int nroDown) {
			Actions actions = new Actions(driver);
	...
	public static void  validaObjetoIsSelect(WebDriver driver, WebElement element) {
		//WebElement radioRegular = driver.findElement(By.xpath("//input[@type='radio' and @value='regular']"));
		boolean isSelected = element.isSelected();

		if (isSelected) {
		    System.out.println("El radio button 'regular' está seleccionado.");
		} else {
		    System.out.println("El radio button 'regular' NO está seleccionado.");
		    //Assert.fail("El radio button 'regular' no está seleccionado.");
		}
