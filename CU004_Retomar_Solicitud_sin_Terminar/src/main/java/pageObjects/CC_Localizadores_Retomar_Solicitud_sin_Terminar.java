...
public interface CC_Localizadores_Retomar_Solicitud_sin_Terminar {
	...
	String optInstitucionSalud = "//div[contains(@class, 'ant-select-item-option') and text()='FONASA']"; //Click para seleccionar fonasa
	...
	String btnguardarycontinuar = "//button[normalize-space()='Guardar y continuar más tarde']"; // Botonera que guarda los registros.
	...
	String btnIngresar2 =  "//button[normalize-space()='Ingresar']"; //XPATH boton ingresar
	String inputRutRetomarSolicitud = "(//input[@id='rut'])[2]"; //XPATH  rut solicitante ubicacion en csv 2
	String btnComenzarRetomarSolicitud = "(//button[normalize-space()='Comenzar'])[2]"; // Presionar Comenzar de Retomar Solicitud sin Terminar	
	...
	String porcentajeAfiliado = "//div[@id='porcentCargoAfiliado']//label[span[text()='0%']]"; //Ingrese el porcentaje de cargo del afiliado a la Administradora del arancel establecido por el D.F.L. Nº1, de 2005
