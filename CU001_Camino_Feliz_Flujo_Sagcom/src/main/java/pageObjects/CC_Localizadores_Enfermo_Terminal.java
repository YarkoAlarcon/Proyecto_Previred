...
public interface CC_Localizadores_Enfermo_Terminal {
	...
	String Anamnesis2 = "//div[text()='Plan de acción']";
	...
	String btnConfigurarAgregarImpedimentos = "//button[span[normalize-space(text())='Configurar y Agregar Impedimentos']]";
	...
	String btnAsignarCie10 = "//button[@type='button' and contains(@class,'ant-btn-link') and span[normalize-space(text())='Asignar cie10']]";
	...
	String radioNo = "(//label[contains(@class, 'ant-radio-wrapper') and //span[text()='No']])[8]";
