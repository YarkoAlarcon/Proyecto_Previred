...
public interface CC_Localizadores_Flujo_Sagcom {
	...
	String clickAcciones = "//button[contains(@class, 'ant-dropdown-trigger')]//div[text()='Acciones']"; //Click en acciones para desplegar opciones
	...
	String regular = "/html/body/div/div/section/main/div/div/section/div/div[3]/div/div[4]/div[2]/div/div/section/div[1]/div[1]/div/label[3]";
